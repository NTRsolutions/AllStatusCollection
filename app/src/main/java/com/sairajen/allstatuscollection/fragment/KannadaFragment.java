...
public class KannadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] title = getResources().getStringArray(R.array.menu_title_kannada);
        String[] table = getResources().getStringArray(R.array.menu_table_kannada);
        int[] thumbnail = {R.drawable.i1,R.drawable.i4,R.drawable.i7,R.drawable.i19,R.drawable.i9,R.drawable.i13,R.drawable.i15,
        ...
        homeAdapter = new MenuAdapter(getActivity(),menuList,"kannada");
