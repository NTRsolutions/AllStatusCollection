...
public class BengaliFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] title = getResources().getStringArray(R.array.menu_title_bengali);
        String[] table = getResources().getStringArray(R.array.menu_table_bengali);
        ...
        homeAdapter = new MenuAdapter(getActivity(),menuList,"bengali");
