...
public class MarathiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String[] title = getResources().getStringArray(R.array.menu_title_marathi);
        String[] table = getResources().getStringArray(R.array.menu_table_marathi);
        int[] thumbnail = {R.drawable.i1,R.drawable.i4,R.drawable.i6, R.drawable.i7,R.drawable.i19,R.drawable.i9,
                R.drawable.i13,R.drawable.i15,R.drawable.i5,R.drawable.cool_apps,R.drawable.ic_launcher};
        ...
        homeAdapter = new MenuAdapter(getActivity(),menuList,"marathi");
